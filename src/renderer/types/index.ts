...
export type WorkspaceTreeLoadingState = 'idle' | 'loading' | 'error';
...
export type FileWorkbenchViewMode = 'edit' | 'preview';
...
export type ServerEvent =
  ...
  | {
      ...
      payload: { path: string; kind: 'add' | 'change' | 'unlink' | 'addDir' | 'unlinkDir' };
    }
